...
<section class="hero">
  <div class="wrap hero-grid">
    <div>
      <span class="hero-eyebrow">● Live booking · real-time availability</span>
      <h1>Your ticket to <span class="accent">what's&nbsp;next.</span></h1>
      <p class="hero-sub">Browse concerts, festivals, and shows near you, pick your tier and seat, and walk in with a QR ticket in your pocket — no printer, no queue.</p>
      ...
      <div class="hero-stats">
        ...
        <div class="hero-stat"><b>Instant</b><span>QR entry</span></div>
        <div class="hero-stat"><b>Real-time</b><span>seat tracking</span></div>
      </div>
    </div>
